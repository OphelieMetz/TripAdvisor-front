/* Truc formulaire back avec mailersend */
...
const sentFrom = new Sender(
  "ophelie@test-51ndgwvkk6nlzqx8.mlsender.net", // `you@${process.env.DOMAIN}` si vous hébergez sur GitHub (n'oubliez pas le nom avant @trial)
  "Ophélie" // votre nom
);
...
app.post("/form", async (req, res) => {
  try {
    ...
    const recipients = [
      new Recipient("ophelie.metz19@gmail.com", `${Ophélie} ${Metz}`),
    ];
    ...
    const emailParams = new EmailParams()
      ...
      .setHtml("<strong>" + "Test Test Test" + "</strong>")
